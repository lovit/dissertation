...
Hidden Markov Model (HMM) 은 Markov property 를 이용하는 방법으로, 오래전부터 이 문제를 위하여 이용되었다.
...
transition based pos tagger \citep{bohnet2012transition} \\
...
transition based neural word segmentation \citep{zhang2016transition} \\

transition based neural word segmentation \citep{cai2017fast} Word, character level embedding 을 모두 이용 \\
