...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{핵심 문장 추출}
문서 내 문장의 위치나 문장에 포함된 단어를 변수로 이용하여 조건부 임의 필드와 같은 순차적 레이블링 알고리즘을 적용하여 핵심 문장을 추출하는 방법도 제안되었다 \citep{shen2007document}

문서 요약 문제는 Document Understanding Conference (DUC, 2001 - 2007) 데이터셋을 이용한 연구가 주로 제안되었다.
...
\caption{(a) Good initial points, (b) Bad initial points}
