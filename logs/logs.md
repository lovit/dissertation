...
# log 7
논문의 감사의 글을 유심히 보는 편인데, 감사하지 않은 사람에게 고맙다고 말하는 경우들이 많아서 대부분의 말은 믿지 않는다.
그런데, 특히 결혼한 사람들이 가족들에게 격려해줘서 고맙다는 말을 하는 경우가 많다.
그 말은 정말 진심이라고 생각한다.
며칠씩 작업을 하고 있으면 혼자라는 외로움이 들 때가 있는데, 그 때 옆에 같이 있어주는 사람에게 얼마나 고마울까.
그래서 졸업식날 가족끼리 사진 찍을 때 서로가 서로를 보는 눈빛을 보는 것을 좋아한다.
그냥. 봄날에 벛꽃 지는데 작업하려니 현타와서 남긴 로그다.

# log 8
어떻게 log 7 같은 로그를 전날 남기나, 뭘 본 것처럼 (하긴 본거지).
몇년 전부터 3, 4 월을 힘들어 했는데, 올해도 사월이 마냥 봄은 아닐 거 같다.
정신 정말 단디 붙잡고 졸업논문을 써가야 할 거 같다.
화낼 것도 뒤돌 것도 없이 잠깐 있던 일일게다라는 마음으로 벌어진 일들부터 하나씩 정리하자. 어후 졸업의 난이도가 상승했습니다.

# log 9
log 3 의 조언을 해주신 분에게 심사가 모두 끝나면 "그 때 내게 조언을 해줘서 감사하다"라는 인사를 하고 싶다는 이야기를 친구들에게 했었다.
그러니 어떤 친구는 그렇게 고맙다면 미루지 말고 여러 번 고맙다라고 인사드리라고도 말해주고, 어떤 친구는 왜 졸업을 한 뒤에 감사하다고 말하는지 이해한다고도 말했다.
모두 가지고 있는 생각이었는데 나는 후자가 더 컸다.
하지만 고맙고 미안하고 사랑한다는 말은 아끼지 말고 하는게 맞다는 생각이 한 번 더 들어서 그 분을 만날 일이 있을 때 그 날의 대화가 내게 정말 큰 도움이었다는 말을 드렸다.
그 말에 큰 힘을 얻어 블로그도 시작했었고, 그 일을 기회로 다른 여러 사람들을 만날 일도 생겼다고도 알려드렸다.
그 분도 그 날의 대화를 기억하고 계셨고, 오히려 "자신의 이야기를 심각하게 (진지하게) 들어줘서 고맙다"라는 말도 해주셨다.
진심을 진심으로 대해주시는 모습을 정말 존경한다.

한 가지 더 조언을 해주셨는데, 그것 역시 기록에 남기고 싶어 로그를 남긴다.
조언을 정리하는 한마디는 "연예인과 전문가"였다.
어떤 분야에 전문성이 생겨 여러 사람들에게 노출되면 (인기가 생기면), 더 큰 인기를 얻기 위해서 "내가 하고 싶은 일이 아닌, 인기를 얻기 위한 일에 집중하는 것"을 경계하라는 이야기이다.
전문가는 자신이 풀고 싶은 문제에 대한 방향성을 가지고 그것을 해결하기 위한 방향으로 그 행보를 만들어야 한다는 것이다 (인기가 없을 수도 있지만).
그리고 그 시작은 느려도 괜찮다고 위로도 해주셨다 (내가 위로로 받아들였다).
예전에 태욱이도 내게 "박사 학위의 Ph.D 의 Ph 는 philosophy 이고, 연구에도 철학이 (방향이) 있어야 박사라 생각한다"는 말을 해줬었는데, 이 역시 마음에 품고 사는 이야기이다.

# log 10
심사가 끝나고 일주일 조금 넘게 흘렀다.
다행히 내용에서의 지적은 많지 않아서 커멘트들에 대한 대응만 잘 한다면 졸업은 할 수 있다.
하지만 졸업에 대한 허락이지, 아직 좋은 논문 혹은 좋은 글에 대한 인정을 받은 것은 아니다.
대화 도중 심사위원 중 한 분 께서 "졸업 논문이 졸업의 근거가 되서는 안된다"고 말하셨다.
하지만 지금 써 놓은 논문은 급하게 구성된 졸렬한 글이다.
부지런하지 못하여 논문에 포함하지 못한 미완성의 챕터들이 아쉽다.
이 논문에서 할 수 있는 범위 안에서 내용을 추가하고, 아쉬움이 남는 것들은 다른 수단으로 글을 완성하고 싶다.
