...
넷째, 다양한 주제로 구성된 문서 집합을 요약하기 위한 문서 군집화 기반 키워드 추출 방법을 제안하였다.
...
그 결과 WordRank 는 20 \% 가 되지 않는 단어 인식 능력을 보이지만, 제안하는 방법은 $R$ 크기의 설정에 따라 70 \% 정도의 단어 인식 능력을 보였다.
...
\centering
\small
\caption{영화 '라라랜드' 리뷰로부터 KR-WordRank, TextRank, 그리고 LexRank 로부터 추출된 핵심 문장 예시}
...
아직 완성되지 않은 부분들을 더 채워 다른 이들에게 도움이 되는 쓸모있는 작업으로 발전 시키겠습니다.

어떻게 살아야 하는지 삶으로 가르침을 주시는 부모님께 감사를 드립니다.
